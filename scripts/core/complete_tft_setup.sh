...
# Create a script to detect and calibrate touch device
# Corrected matrix for portrait mode (right rotation): 0 1 0 -1 0 1 0 0 1
# This maps: touch-x to screen-y, touch-y to inverted screen-x
